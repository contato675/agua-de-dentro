...
const routeCopy={
 en:[['Caeté-Açu','4 trails + 5 local research days','Water, vegetation, rocks, memory, conversations and repeated return to the studio.'],['Vale do Pati','7 days · 6 nights','Walking, permanence, water, agriculture, housing, work, hospitality and soundscape.'],['Mucugê / Igatu','4 days · 3 nights','Mining histories, stone construction, water, archives, memory and contemporary life.']],
 'pt-BR':[['Caeté-Açu','4 trilhas + 5 dias de pesquisa local','Água, vegetação, pedras, memória, conversas e retorno continuado ao ateliê.'],['Vale do Pati','7 dias · 6 noites','Caminhada, permanência, água, agricultura, moradia, trabalho, hospitalidade e paisagem sonora.'],['Mucugê / Igatu','4 dias · 3 noites','Histórias do garimpo, pedra construída, água, arquivos, memória e vida contemporânea.']],
 fr:[['Caeté-Açu','4 sentiers + 5 jours de recherche locale','Eau, végétation, roches, mémoire, conversations et retours réguliers à l’atelier.'],['Vale do Pati','7 jours · 6 nuits','Marche, séjour, eau, agriculture, habitat, travail, hospitalité et paysage sonore.'],['Mucugê / Igatu','4 jours · 3 nuits','Histoires du garimpo, constructions en pierre, eau, archives, mémoire et vie contemporaine.']],
 es:[['Caeté-Açu','4 senderos + 5 días de investigación local','Agua, vegetación, piedras, memoria, conversaciones y retorno continuado al taller.'],['Vale do Pati','7 días · 6 noches','Caminata, permanencia, agua, agricultura, vivienda, trabajo, hospitalidad y paisaje sonoro.'],['Mucugê / Igatu','4 días · 3 noches','Historias del garimpo, piedra construida, agua, archivos, memoria y vida contemporánea.']]
};
...
function teamSection(data,locale){
 ...
 const renataUrl=`https://renataalberigi.com.br/${locale==='en'?'':locale==='pt-BR'?'pt-br/':locale+'/'}`;
